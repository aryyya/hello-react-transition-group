...
const About = () => {
  return (
    <div>
      ...
      <p style={style}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus ducimus doloribus architecto molestiae dolor assumenda labore at velit voluptatum. Nulla, alias ex totam illo reprehenderit ipsam fuga repellendus delectus ab.</p>
    </div>
  )
}
